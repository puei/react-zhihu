...
function SvgMess(props) {
  return (
    <svg
      className="prefix__Zi prefix__Zi--Comments"
      fill="currentColor"
      viewBox="0 0 24 24"
      width={22}
      height={22}
